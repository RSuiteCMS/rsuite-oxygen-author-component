...
public class JnlpRemoteApiResult
  implements RemoteApiResult
{
  ...
  protected String contentType = "application/x-java-jnlp-file"; // Default content type
  protected String encoding = "UTF-8"; 
  protected ResponseStatus responseStatus = ResponseStatus.SUCCESS;
  protected String suggestedFileName = null; //"open-oxygen.jnlp";
  
  protected InputStream inputStream;
  
  
  public JnlpRemoteApiResult(byte[] bytes) {	
	this.inputStream = new ByteArrayInputStream(bytes);
}

  public JnlpRemoteApiResult(InputStream is) {	
	this.inputStream = is;
}

public JnlpRemoteApiResult(
    String content) 
  {
