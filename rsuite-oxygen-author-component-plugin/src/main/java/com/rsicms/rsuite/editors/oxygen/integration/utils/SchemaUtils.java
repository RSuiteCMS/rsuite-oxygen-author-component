...
import com.rsicms.rsuite.editors.oxygen.integration.utils.resolver.RSuiteOxygenEntityResolver;
import com.rsicms.rsuite.editors.oxygen.integration.utils.resolver.RSuiteXmlResolver;
...
public class SchemaUtils {
	...
	private static Set<String> obtainRelatedSchemaSet(ExecutionContext context,
		...
		EntityResolver rsuiteEntityResolver = new RSuiteOxygenEntityResolver(
				context);
